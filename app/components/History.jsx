    ...
    return (
        <main className="p-4 grid justify-center items-center w-full min-h-screen mt-18 mb-2 md:mb-60">
            <div className="grid items-center justify-center mb-18" data-aos="fade-up" data-aos-anchor-placement="top-center">
                ...
                <p className="text-sm font-['Times_New_Roman'] md:text-sm text-gray-800 text-center max-w-80 md:max-w-4xl leading-relaxed"
            ...
            <div className="grid md:flex items-center justify-center gap-8 mt-12" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                ...
                <div className="grid mb-16 md:mb-38 tracking-wide -mt-4 md:mt-28">
                    ...
                    <p className="text-sm font-['Times_New_Roman'] md:text-sm text-gray-800 text-left min-w-74 md:max-w-xl leading-relaxed mb-6"
                ...
                <div className="flex justify-between items-center" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <button className="rounded-md font-bold bg-slate-600 w-32 h-10 cursor-pointer text-sm hover:bg-slate-800"><Link href="/about" className="block text-white">Tentang kami</Link></button>
                    <Avatar />
                </div>
                </div>
            </div>
            ...
            <div className="grid md:flex items-center justify-center gap-8 mt-0 md:mt-16">
                <div className="grid max-w-xl" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    ...
                    <p className="text-sm font-['Times_New_Roman'] md:text-sm text-gray-800 text-left min-w-74 md:max-w-xl leading-relaxed"
                    ...
                    <ul className="text-black font-['Times_New_Roman'] text-sm mt-2 max-w-3xl mb-2 tracking-wide">
